...
set_property PACKAGE_PIN T1 [get_ports {SWITCH4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SWITCH4}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
set_property PACKAGE_PIN R3 [get_ports {SWITCH3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SWITCH3}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {SWITCH2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SWITCH2}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {SWITCH1}]					
...
#set_property PACKAGE_PIN T4 [get_ports {led_lect[10]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[10]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {led_lect[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[9]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {led_lect[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[8]}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
#set_property PACKAGE_PIN V4 [get_ports {led_lect[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[7]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
#set_property PACKAGE_PIN U3 [get_ports {led_lect[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[6]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
#set_property PACKAGE_PIN V1 [get_ports {led_lect[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[5]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
#set_property PACKAGE_PIN R1 [get_ports {led_lect[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[4]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
#set_property PACKAGE_PIN P5 [get_ports {led_lect[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[3]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {led_lect[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[2]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {led_lect[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[1]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {led_lect[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {led_lect[0]}]
...
set_property PACKAGE_PIN E16 [get_ports BOUTON_BACK]						
	set_property IOSTANDARD LVCMOS33 [get_ports BOUTON_BACK]
...
set_property PACKAGE_PIN H2 [get_ports {SS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SS}]
##Bank = 35, Pin name = IO_L20P_T3_35,						Sch name = JD8
set_property PACKAGE_PIN G4 [get_ports {MOSI}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MOSI}]
